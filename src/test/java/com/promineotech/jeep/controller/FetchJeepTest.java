...
class FetchJeepTest extends FetchJeepTestSupport {
	...
	class TestsThatDoNotPolluteTheApplicationContext extends FetchJeepTestSupport
	{
		...
		@Test
		void testThatAnErrorMessgeIsReturnedWhenAnUnknownTrimIsSupplied() {
			//Given: a valid model, trim and URI
			JeepModel model = JeepModel.WRANGLER;
		...
		void testThatAnErrorMessgeIsReturnedWhenAnInvalidValueIsSupplied(String model, String trim, String reason) {
			//Given: a valid model, trim and URI
	...
	static Stream<Arguments> parametersForInvalidInput() {
		return Stream.of(
				arguments("WRANGLER", "987hhy", "Trim contains non-alpha numeric args"),
